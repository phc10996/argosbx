...
Vless-ws-tls为默认安装，Argo固定或临时隧道为可选，也可使用[workers/pages反代方式](https://github.com/phc10996/argosbx/blob/main/_worker.js)启用Vless-ws-tls的CDN替代Argo的CDN
...
```curl -sSL https://raw.githubusercontent.com/phc10996/argosbx/main/sap.sh -o sap.sh && chmod +x sap.sh && bash sap.sh```

或者

```wget -q https://raw.githubusercontent.com/phc10996/argosbx/main/sap.sh -O sap.sh && chmod +x sap.sh && bash sap.sh```
...
```curl -sSL https://raw.githubusercontent.com/phc10996/argosbx/main/saph.sh -o saph.sh && chmod +x saph.sh && bash saph.sh```

或者

```wget -q https://raw.githubusercontent.com/phc10996/argosbx/main/saph.sh -O saph.sh && chmod +x saph.sh && bash saph.sh```
